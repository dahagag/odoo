locals {
  ...
  domain = var.environment == "prod" ? "${var.trial_org_subdomain_label}.${var.root_domain}" : "${var.trial_org_subdomain_label}.${var.dev_subdomain}"

  log_group_name = "/hosting/trial-orgs/${var.trial_org_id}"
}
